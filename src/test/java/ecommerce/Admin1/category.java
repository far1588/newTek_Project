...
UtilityClassObject.getTest().log(Status.INFO, "send image address ");
File fileupload2=new File("C:\\Users\\DELL\\eclipse-workspace\\SeleniumECommerceFramework\\image\\harryyy.jpg");
...
UtilityClassObject.getTest().log(Status.INFO, "send image address ");
File fileupload3=new File("C:\\Users\\DELL\\eclipse-workspace\\SeleniumECommerceFramework\\image\\potter.jpg");
...
UtilityClassObject.getTest().log(Status.INFO, "search btn ");
 ...
 if(actprod.trim().contains(productname)) {
